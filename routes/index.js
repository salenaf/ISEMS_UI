...
module.exports = function(app, socketIo) {
        ...
        usersSessionInformation.setSessionID(req.session.passport.user, req.sessionID, err => {
            ...
            headerPage(req, (err, objHeader) => {
                if (err) {
                    ...
                    pages.mainPage.call(null, req, res, {});

                    return;
                }

                pages.mainPage.call(null, req, res, objHeader);
            });
        });
    });
    ...
    app.get('/analysis_sip', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.analysisSIP.call(null, req, res, {}, socketIo);
            } else {
                pages.analysisSIP.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/security_event_management', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.securityEventManagement.call(null, req, res, {}, socketIo);
            } else {
                pages.securityEventManagement.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/network_interaction', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.networkInteraction.call(null, req, res, {}, socketIo);
            } else {
                pages.networkInteraction.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/decode_tools', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.toolsDecode.call(null, req, res, {}, socketIo);
            } else {
                pages.toolsDecode.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/search_tools', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.toolsSearch.call(null, req, res, {}, socketIo);
            } else {
                pages.toolsSearch.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_groups', isAuthenticated, (req, res) => {
        headerPage(req, (err, objHeader) => {
            if (err) {
                writeLogFile('error', err.toString());
                pages.managementGroups.call(null, req, res, {});

                return;
            }

            pages.managementGroups.call(null, req, res, objHeader);
        });
    });
    ...
    /*app.post('/setting_groups', isAuthenticated, (req, res) => {
        ...
        checkAccessRightsExecute({
            ...
            if (!successfully) {
                ...
                processingManagementGroups(req, res, jsonObj => {
                    res.json(jsonObj).end();
                });
            }
        });
    ...
    app.get('/setting_users', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.managementUsers.call(null, req, res, {}, socketIo);
            } else {
                pages.managementUsers.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_objects_and_subjects', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.managementObjectsAndSubjects.call(null, req, res, {}, socketIo);
            } else {
                pages.managementObjectsAndSubjects.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_ids_rules', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.managementIdsRules.call(null, req, res, {}, socketIo);
            } else {
                pages.managementIdsRules.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_search_rules', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.managementSearchRules.call(null, req, res, {}, socketIo);
            } else {
                pages.managementSearchRules.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_geoip', isAuthenticated, (req, res) => {
        ...
        headerPage(req, (err, objHeader) => {
            if (err) {
                ...
                pages.managementGeoIp.call(null, req, res, {}, socketIo);
            } else {
                pages.managementGeoIp.call(null, req, res, objHeader, socketIo);
            }
        });
    });
    ...
    app.get('/setting_events', isAuthenticated, (req, res) => {
        //получаем заголовок страницы
        headerPage(req, (err, objHeader) => {
            if (err) {
                writeLogFile('error', err.toString());

                pages.managementEvents.call(null, req, res, {}, socketIo);
            } else {
                pages.managementEvents.call(null, req, res, objHeader, socketIo);
            }
        });
    });
