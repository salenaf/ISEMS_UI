...
function (_React$Component) {
  ...
  _createClass(CreateHeaderMenu, [{
    ...
    value: function render() {
      var createMenu = function createMenu(objMenuItem) {
        var tmpArr = [];

        for (var key in objMenuItem) {
          var submenuIsExist = Object.keys(objMenuItem[key].submenu).length;
          ...
          }, objMenuItem[key].name, " ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
