 ...
 *      Нужно сделать:
 *      !!! ВАЖНО !!!
 * Почему то задач по скачиванию файлов найдено 4, хотя
 * одна из задач полностью выполнена и все файлы по ней
 * были СКАЧЕНЫ, ее в этой таблице быть не должно, ПРОВЕРИТЬ
 * 
